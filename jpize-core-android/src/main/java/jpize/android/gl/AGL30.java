...
public class AGL30 extends AGL20 implements IGL30 {
    ...
    // depth, int format, int imageSize, Buffer data) {
...
// @Override
// public void glGetTransformFeedbackVarying(int program, int index, int bufsize, IntBuffer length, IntBuffer
// size, IntBuffer type, byte name) {
...
// binaryFormatOffset, Buffer binary) {
