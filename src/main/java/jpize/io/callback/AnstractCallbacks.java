...
public abstract class AnstractCallbacks {
    ...
    protected final List<IMEStatusCallback> imeStatus = new CopyOnWriteArrayList<>();
    ...
    public void removeIMEStatusCallback(IMEStatusCallback callback) {
