...
public class GlRenderbuffer extends GlObject {
    ...
    public static final GlRenderbufferTarget TAGET = GlRenderbufferTarget.RENDERBUFFER;
    ...
    public void setStorage(int width, int height) {
        this.bind();
        Jpize.GL30.glRenderbufferStorage(TAGET.value, format.value, width, height);
        this.unbind();
    }
    ...
    public GlRenderbuffer bind() {
        Jpize.GL30.glBindRenderbuffer(TAGET.value, ID);
        return this;
    }

    public GlRenderbuffer unbind() {
        Jpize.GL30.glBindRenderbuffer(TAGET.value, 0);
        return this;
    }
