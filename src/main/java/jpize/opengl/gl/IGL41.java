...
public interface IGL41 extends IGL40 {
    ...
    void nglShaderBinary(int count, long shaders, int binaryformat, long binary, int length);
    void glShaderBinary(IntBuffer shaders, int binaryformat, ByteBuffer binary);
    void nglGetShaderPrecisionFormat(int shadertype, int precisiontype, long range, long precision);
    ...
    void nglGetProgramBinary(int program, int bufSize, long length, long binaryFormat, long binary);
    void glGetProgramBinary(int program, IntBuffer length, IntBuffer binaryFormat, ByteBuffer binary);
    void nglProgramBinary(int program, int binaryFormat, long binary, int length);
    ...
    int nglCreateShaderProgramv(int type, int count, long strings);
    ...
    void nglProgramUniform1iv(int program, int location, int count, long value);
    void glProgramUniform1iv(int program, int location, IntBuffer value);
    void nglProgramUniform2iv(int program, int location, int count, long value);
    void glProgramUniform2iv(int program, int location, IntBuffer value);
    void nglProgramUniform3iv(int program, int location, int count, long value);
    void glProgramUniform3iv(int program, int location, IntBuffer value);
    void nglProgramUniform4iv(int program, int location, int count, long value);
    void glProgramUniform4iv(int program, int location, IntBuffer value);
    void nglProgramUniform1uiv(int program, int location, int count, long value);
    void glProgramUniform1uiv(int program, int location, IntBuffer value);
    void nglProgramUniform2uiv(int program, int location, int count, long value);
    void glProgramUniform2uiv(int program, int location, IntBuffer value);
    void nglProgramUniform3uiv(int program, int location, int count, long value);
    void glProgramUniform3uiv(int program, int location, IntBuffer value);
    void nglProgramUniform4uiv(int program, int location, int count, long value);
    void glProgramUniform4uiv(int program, int location, IntBuffer value);
    void nglProgramUniform1fv(int program, int location, int count, long value);
    void glProgramUniform1fv(int program, int location, FloatBuffer value);
    void nglProgramUniform2fv(int program, int location, int count, long value);
    void glProgramUniform2fv(int program, int location, FloatBuffer value);
    void nglProgramUniform3fv(int program, int location, int count, long value);
    void glProgramUniform3fv(int program, int location, FloatBuffer value);
    void nglProgramUniform4fv(int program, int location, int count, long value);
    void glProgramUniform4fv(int program, int location, FloatBuffer value);
    void nglProgramUniform1dv(int program, int location, int count, long value);
    void glProgramUniform1dv(int program, int location, DoubleBuffer value);
    void nglProgramUniform2dv(int program, int location, int count, long value);
    void glProgramUniform2dv(int program, int location, DoubleBuffer value);
    void nglProgramUniform3dv(int program, int location, int count, long value);
    void glProgramUniform3dv(int program, int location, DoubleBuffer value);
    void nglProgramUniform4dv(int program, int location, int count, long value);
    void glProgramUniform4dv(int program, int location, DoubleBuffer value);
    void nglProgramUniformMatrix2fv(int program, int location, int count, boolean transpose, long value);
    void glProgramUniformMatrix2fv(int program, int location, boolean transpose, FloatBuffer value);
    void nglProgramUniformMatrix3fv(int program, int location, int count, boolean transpose, long value);
    void glProgramUniformMatrix3fv(int program, int location, boolean transpose, FloatBuffer value);
    void nglProgramUniformMatrix4fv(int program, int location, int count, boolean transpose, long value);
    void glProgramUniformMatrix4fv(int program, int location, boolean transpose, FloatBuffer value);
    void nglProgramUniformMatrix2dv(int program, int location, int count, boolean transpose, long value);
    void glProgramUniformMatrix2dv(int program, int location, boolean transpose, DoubleBuffer value);
    void nglProgramUniformMatrix3dv(int program, int location, int count, boolean transpose, long value);
    void glProgramUniformMatrix3dv(int program, int location, boolean transpose, DoubleBuffer value);
    void nglProgramUniformMatrix4dv(int program, int location, int count, boolean transpose, long value);
    void glProgramUniformMatrix4dv(int program, int location, boolean transpose, DoubleBuffer value);
    void nglProgramUniformMatrix2x3fv(int program, int location, int count, boolean transpose, long value);
    void glProgramUniformMatrix2x3fv(int program, int location, boolean transpose, FloatBuffer value);
    void nglProgramUniformMatrix3x2fv(int program, int location, int count, boolean transpose, long value);
    void glProgramUniformMatrix3x2fv(int program, int location, boolean transpose, FloatBuffer value);
    void nglProgramUniformMatrix2x4fv(int program, int location, int count, boolean transpose, long value);
    void glProgramUniformMatrix2x4fv(int program, int location, boolean transpose, FloatBuffer value);
    void nglProgramUniformMatrix4x2fv(int program, int location, int count, boolean transpose, long value);
    void glProgramUniformMatrix4x2fv(int program, int location, boolean transpose, FloatBuffer value);
    void nglProgramUniformMatrix3x4fv(int program, int location, int count, boolean transpose, long value);
    void glProgramUniformMatrix3x4fv(int program, int location, boolean transpose, FloatBuffer value);
    void nglProgramUniformMatrix4x3fv(int program, int location, int count, boolean transpose, long value);
    void glProgramUniformMatrix4x3fv(int program, int location, boolean transpose, FloatBuffer value);
    void nglProgramUniformMatrix2x3dv(int program, int location, int count, boolean transpose, long value);
    void glProgramUniformMatrix2x3dv(int program, int location, boolean transpose, DoubleBuffer value);
    void nglProgramUniformMatrix3x2dv(int program, int location, int count, boolean transpose, long value);
    void glProgramUniformMatrix3x2dv(int program, int location, boolean transpose, DoubleBuffer value);
    void nglProgramUniformMatrix2x4dv(int program, int location, int count, boolean transpose, long value);
    void glProgramUniformMatrix2x4dv(int program, int location, boolean transpose, DoubleBuffer value);
    void nglProgramUniformMatrix4x2dv(int program, int location, int count, boolean transpose, long value);
    void glProgramUniformMatrix4x2dv(int program, int location, boolean transpose, DoubleBuffer value);
    void nglProgramUniformMatrix3x4dv(int program, int location, int count, boolean transpose, long value);
    void glProgramUniformMatrix3x4dv(int program, int location, boolean transpose, DoubleBuffer value);
    void nglProgramUniformMatrix4x3dv(int program, int location, int count, boolean transpose, long value);
    ...
    void nglGetProgramPipelineInfoLog(int pipeline, int bufSize, long length, long infoLog);
    ...
    void nglVertexAttribL1dv(int index, long v);
    void glVertexAttribL1dv(int index, DoubleBuffer v);
    void nglVertexAttribL2dv(int index, long v);
    void glVertexAttribL2dv(int index, DoubleBuffer v);
    void nglVertexAttribL3dv(int index, long v);
    void glVertexAttribL3dv(int index, DoubleBuffer v);
    void nglVertexAttribL4dv(int index, long v);
    void glVertexAttribL4dv(int index, DoubleBuffer v);
    void nglVertexAttribLPointer(int index, int size, int type, int stride, long pointer);
