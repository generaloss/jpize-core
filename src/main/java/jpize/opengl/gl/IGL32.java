...
public interface IGL32 extends IGL31 {
    ...
    void nglGetBufferParameteri64v(int target, int pname, long params);
    void glGetBufferParameteri64v(int target, int pname, LongBuffer params);
    long glGetBufferParameteri64(int target, int pname);
    void nglDrawElementsBaseVertex(int mode, int count, int type, long indices, int basevertex);
    ...
    void nglDrawRangeElementsBaseVertex(int mode, int start, int end, int count, int type, long indices, int basevertex);
    ...
    void nglDrawElementsInstancedBaseVertex(int mode, int count, int type, long indices, int primcount, int basevertex);
    ...
    void nglMultiDrawElementsBaseVertex(int mode, long count, int type, long indices, int drawcount, long basevertex);
    ...
    void nglGetMultisamplefv(int pname, int index, long val);
