...
public interface IGL43 extends IGL42 {
    ...
    void nglClearBufferData(int target, int internalformat, int format, int type, long data);
    ...
    void nglClearBufferSubData(int target, int internalformat, long offset, long size, int format, int type, long data);
    ...
    void nglDebugMessageControl(int source, int type, int severity, int count, long ids, boolean enabled);
    ...
    void nglDebugMessageInsert(int source, int type, int id, int severity, int length, long message);
    ...
    void nglDebugMessageCallback(long callback, long userParam);
    interface GLDebugMessageCallbackI {
        void invoke(long callback, long userParam);
    }
    void glDebugMessageCallback(GLDebugMessageCallbackI callback, long userParam);
    int nglGetDebugMessageLog(int count, int bufsize, long sources, long types, long ids, long severities, long lengths, long messageLog);
    ...
    void nglPushDebugGroup(int source, int id, int length, long message);
    ...
    void nglObjectLabel(int identifier, int name, int length, long label);
    void glObjectLabel(int identifier, int name, ByteBuffer label);
    void glObjectLabel(int identifier, int name, CharSequence label);
    void nglGetObjectLabel(int identifier, int name, int bufSize, long length, long label);
    ...
    void nglObjectPtrLabel(long ptr, int length, long label);
    void glObjectPtrLabel(long ptr, ByteBuffer label);
    void glObjectPtrLabel(long ptr, CharSequence label);
    void nglGetObjectPtrLabel(long ptr, int bufSize, long length, long label);
    ...
    void nglGetFramebufferParameteriv(int target, int pname, long params);
    ...
    void nglGetInternalformati64v(int target, int internalformat, int pname, int bufSize, long params);
    ...
    void nglInvalidateFramebuffer(int target, int numAttachments, long attachments);
    void glInvalidateFramebuffer(int target, IntBuffer attachments);
    void glInvalidateFramebuffer(int target, int attachment);
    void nglInvalidateSubFramebuffer(int target, int numAttachments, long attachments, int x, int y, int width, int height);
    ...
    void nglMultiDrawArraysIndirect(int mode, long indirect, int drawcount, int stride);
    ...
    void nglMultiDrawElementsIndirect(int mode, int type, long indirect, int drawcount, int stride);
    ...
    void nglGetProgramInterfaceiv(int program, int programInterface, int pname, long params);
    ...
    int nglGetProgramResourceIndex(int program, int programInterface, long name);
    ...
    void nglGetProgramResourceName(int program, int programInterface, int index, int bufSize, long length, long name);
    ...
    void nglGetProgramResourceiv(int program, int programInterface, int index, int propCount, long props, int bufSize, long length, long params);
    void glGetProgramResourceiv(int program, int programInterface, int index, IntBuffer props, IntBuffer length, IntBuffer params);
    int nglGetProgramResourceLocation(int program, int programInterface, long name);
    ...
    int nglGetProgramResourceLocationIndex(int program, int programInterface, long name);
