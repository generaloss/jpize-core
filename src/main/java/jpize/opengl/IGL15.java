...
public interface IGL15 extends IGL14 {
    ...
    void nglDeleteBuffers(int n, long buffers);
    void glDeleteBuffers(IntBuffer buffers);
    void glDeleteBuffers(int buffer);
    void nglGenBuffers(int n, long buffers);
    void glGenBuffers(IntBuffer buffers);
    int glGenBuffers();
    boolean glIsBuffer(int buffer);
    void nglBufferData(int target, long size, long data, int usage);
    ...
    void nglBufferSubData(int target, long offset, long size, long data);
    ...
    void nglGetBufferSubData(int target, long offset, long size, long data);
    ...
    void nglGetQueryObjectuiv(int id, int pname, long params);
