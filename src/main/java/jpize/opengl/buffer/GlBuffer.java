...
public class GlBuffer extends GlObject {
    ...
    public void copySubData(GlBuffer buffer, long readOffset, long writeOffset, long size) {
        Jpize.GL15.glBindBuffer(IGL32.GL_COPY_READ_BUFFER, ID);
        Jpize.GL15.glBindBuffer(IGL32.GL_COPY_WRITE_BUFFER, buffer.ID);
        Jpize.GL31.glCopyBufferSubData(IGL32.GL_COPY_READ_BUFFER, IGL32.GL_COPY_WRITE_BUFFER, readOffset, writeOffset, size);
    }
